...
# --- COMPRESSED CSS STYLING (To prevent copy-paste errors) ---
st.markdown("""
    <style>
...
with tab1:
    ...
    with row1_col1:
        ...
        fig_wins.update_layout(plot_bgcolor='white', paper_bgcolor='white', font=dict(family="Plus Jakarta Sans", color="#
